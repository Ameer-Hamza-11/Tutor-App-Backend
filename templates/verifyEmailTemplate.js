        ...
        <tr>
          <td align="center" style="padding: 32px 12px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="container" style="width:600px; background:#ffffff; border-radius:20px; box-shadow:0 10px 35px rgba(0,0,0,0.08); overflow:hidden;">
              ...
              <!-- HEADER -->
              <tr>
                <td align="center" style="background:linear-gradient(90deg,#ff7b00,#ff4d00); padding: 20px;">
                  <img src="https://dummyimage.com/160x40/ffffff/ff6b00.png&text=Tutor+App" width="160" height="40" alt="Tutor App" style="display:block; border:0;">
              ...
              <tr>
                <td align="center" style="padding: 20px 28px 0 28px;">
                  <div style="display:inline-block; padding: 22px 28px; border-radius:16px; background:rgba(255,107,0,0.06); border:2px solid #ff6b00; backdrop-filter: blur(6px);">
                    <div class="otp" style="font:700 38px/1.2 'Courier New', Courier, monospace; color:#ff6b00; letter-spacing:14px; text-align:center; white-space:nowrap;">
                      ${otp}
                    </div>
                  </div>
              ...
              <tr>
                <td align="center" style="padding: 28px 28px 0 28px;">
                  <a href="#" style="display:inline-block; font:700 15px/1.2 Arial,Helvetica,sans-serif; color:#ffffff; text-decoration:none; background:linear-gradient(90deg,#ff7b00,#ff4d00); padding: 15px 28px; border-radius:12px; box-shadow:0 6px 16px rgba(255,107,0,0.4); transition:all .3s;">
                    Open Tutor App
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td class="px-24" style="padding: 18px 28px 0 28px;">
                  ...
                  <p style="margin:0; font:400 13px/1.6 Arial,Helvetica,sans-serif; color:#4b5563;">
                    ...
                    <a href="mailto:support@tutorapp.com" style="color:#ff6b00; text-decoration:none;">support@tutorapp.com</a>.
                  </p>
                </td>
              </tr>
