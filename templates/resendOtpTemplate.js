const resendOtpTemplate = (name, otp) => {
    ...
    <head>
      <meta charset="utf-8">
      <title>Tutor App – Resend OTP</title>
    ...
    <body style="margin:0; padding:0; background:#eff6ff; font-family:Arial,Helvetica,sans-serif;">
      ...
      <div style="display:none; overflow:hidden; line-height:1px; opacity:0; max-height:0; max-width:0;">
        Your new Tutor App OTP is ${otp}. It expires in 10 minutes.
      </div>
  
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#eff6ff;">
        <tr>
          <td align="center" style="padding: 32px 12px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="container" style="width:600px; background:#ffffff; border-radius:20px; box-shadow:0 10px 35px rgba(0,0,0,0.08); overflow:hidden;">
              ...
              <!-- HEADER -->
              <tr>
                <td align="center" style="background:linear-gradient(90deg,#2563eb,#4f46e5); padding: 20px;">
                  <img src="https://dummyimage.com/160x40/ffffff/2563eb.png&text=Tutor+App" width="160" height="40" alt="Tutor App" style="display:block; border:0;">
              ...
              <tr>
                <td class="px-24" style="padding: 0 28px 14px 28px;">
                  <p class="lead" style="margin:0; font:400 16px/1.6 Arial,Helvetica,sans-serif; color:#374151;">
                    You requested a new OTP for <strong>Tutor App</strong>. Use the code below to verify your email again and continue your journey 🚀
                  </p>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" style="padding: 20px 28px 0 28px;">
                  <div style="display:inline-block; padding: 22px 28px; border-radius:16px; background:rgba(37,99,235,0.08); border:2px solid #2563eb; backdrop-filter: blur(6px);">
                    <div class="otp" style="font:700 38px/1.2 'Courier New', Courier, monospace; color:#2563eb; letter-spacing:14px; text-align:center; white-space:nowrap;">
                      ${otp}
                    </div>
                  </div>
              ...
              <tr>
                <td align="center" style="padding: 28px 28px 0 28px;">
                  <a href="#" style="display:inline-block; font:700 15px/1.2 Arial,Helvetica,sans-serif; color:#ffffff; text-decoration:none; background:linear-gradient(90deg,#2563eb,#4f46e5); padding: 15px 28px; border-radius:12px; box-shadow:0 6px 16px rgba(37,99,235,0.4); transition:all .3s;">
                    Verify Again
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td class="px-24" style="padding: 20px 28px 0 28px;">
                  <p style="margin:0; font:400 13px/1.6 Arial,Helvetica,sans-serif; color:#6b7280;">
                    ⏳ This OTP will expire in <strong>10 minutes</strong>. Keep it private for your security.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                <td class="px-24" style="padding: 18px 28px 0 28px;">
                  ...
                  <p style="margin:0; font:400 13px/1.6 Arial,Helvetica,sans-serif; color:#4b5563;">
                    Didn’t request this OTP? Ignore this email. Questions? Contact us at
                    <a href="mailto:support@tutorapp.com" style="color:#2563eb; text-decoration:none;">support@tutorapp.com</a>.
                  </p>
                </td>
              </tr>
